...
const Tabata: React.FC = () => {
  ...
  useKeepAwake(running && !paused && !ended ? 'tabata' : undefined);
      ...
      headerRight: () =>
        !running ? (
          <Pressable
            ...
            accessibilityLabel="save Tabata workout"
          >
  ...
  if (!running) {
    return (
      <SetupShell>
        ...
        <CmdButton text="START" onPress={start} disabled={!work || !rounds} size="large" />
